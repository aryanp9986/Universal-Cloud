...
import { budgetServers } from "../api/serversAPI";
import { NavLink } from "react-router-dom";
import "./budgetservers.css"

const BudgetServers = () => {
  document.title = "Budget Servers | Universal Cloud";

  const redirectToPayment = (planName) => {
    window.location.replace(`/pay/BudgetServers/${planName}`);
  }
  return (
    <div className="bservers bservers-body">
        ...
        <div className="neon-box">
          ...
          <section
            ...
            <div className="px-4 py-10 max-w-6xl mx-auto">
              <h1 className="section-title">Budget Minecraft Server Plans</h1>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {budgetServers.map(plan => {
                  return <>
                    <div className="card">
