...
import { proVPS } from "../api/serversAPI";
import "./provps.css"

const ProVPS = () => {
  document.title = "Pro VPS | Universal Cloud";

  const redirectToPayment = (planName) => {
    window.location.replace(`/pay/ProVPS/${planName}`);
  }
  return (
    <div className="pvps pvps-body">
        ...
        <div className="neon-box">
          ...
          <section
            ...
            <div className="px-4 py-10 max-w-6xl mx-auto">
              <h1 className="section-title">Pro VPS Hosting Plans</h1>
