...
import { premiumServers } from "../api/serversAPI";
import { NavLink, redirect } from "react-router-dom";
import "./premiumservers.css";

const PremiumServers = () => {
  document.title = "Premium Servers | Universal Cloud";

  const redirectToPayment = (planName) => {
    window.location.replace(`/pay/PremiumServers/${planName}`);
  }
  return (
    <div className="pservers pservers-body">
        ...
        <div className="neon-box">
          ...
          <section
            ...
            <div className="px-4 py-10 max-w-6xl mx-auto">
              <h1 className="section-title">Premium Minecraft Server Plans</h1>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {premiumServers.map(plan => {
                  return <>
                    <div className="card">
